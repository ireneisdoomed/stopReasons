...
toplot_efficacy_main <- all_tests %>%
    filter(predictionType %in% c("clinical", "stopStatus") | prediction %in% c("Covid19", "Business_Administrative", "Negative", "Study_Design", "Safety_Sideeffects", "Insufficient_Enrollment")) %>%
