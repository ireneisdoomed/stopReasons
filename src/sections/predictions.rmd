...
precitions_path <- "gs://ot-team/dochoa/stopped_predictions_formatted_30_09_22.csv"
stop_predictions <- spark_read_csv(
    ...
    mutate(last_update_posted_date = as.Date(last_update_posted_date, format = "%d/%m/%Y")) %>%
...
p_byta_highlights <- byta_data2plot %>%
    ...
    scale_fill_manual(
        ...
        # values = c("#E64B35FF", "#4DBBD5FF", "#00A087FF", "#3C5488FF", "#F39B7FFF", "#8491B4FF", "#91D1C2FF", "#DC0000FF", "#7E6148FF"),
