...
from utils import (convert_to_tf_dataset, get_label_metadata, subset_split)
...
def main():
    ...
    model.save_pretrained('models/model_all_1_epochs_classificator_tf_multi_label', saved_model=True, save_format='tf')
